...
def main():
    ...
    parser.add_argument('--init_dir', type=str, default='ch2ch/output',
                        help='continue from the outputs in the given directory')

    # Parameters for picking which model to use. 
    parser.add_argument('--model_path', type=str, default='/home/kuznetsov/qa_dialog/tensorflow-char-rnn/ch2ch/output/best_model/model-2418',
